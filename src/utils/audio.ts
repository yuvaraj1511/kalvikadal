/**
 * Web Audio API synthesizer for sound effects (clicks, success chimes, fanfares)
 * and Web Speech API for Tamil and English pronunciations.
 */
...
class SoundManager {
  ...
  speak(text: string, lang: 'ta-IN' | 'en-US' = 'ta-IN') {
    if (typeof window === 'undefined' || !('speechSynthesis' in window)) return;
    try {
      window.speechSynthesis.cancel();
      const utterance = new SpeechSynthesisUtterance(text);
      utterance.lang = lang;
      utterance.rate = 0.9; // gentle speed for kids
